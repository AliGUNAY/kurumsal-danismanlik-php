<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-19 16:32:35
  from "/home/goxskons/public_html/theme/admin/pages/gallery/index.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_578e2bf3656b30_88180137',
  'file_dependency' => 
  array (
    'c56931a3378a47afb03a27b505d413b0bfbfeed3' => 
    array (
      0 => '/home/goxskons/public_html/theme/admin/pages/gallery/index.tpl',
      1 => 1468935152,
      2 => 'file',
    ),
  ),
...
function content_578e2bf3656b30_88180137 ($_smarty_tpl) {
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a  href="index.php?page=page/gallery/add" class="btn btn-cyanide"><i class="fa fa-tags"></i> Ekle</a>
									</div>
									...
									<table class="table table-striped">
										<thead> 
											<tr>
												...
												<th style="width: 45px;">Kapak Resmi</th>
											...
											<tbody id="sortablecategory" data-page="page/gallery/sort">
...
" data-database="page/gallery/status" data-id="<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['don']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td><img style="    width: 200px;" src="../upload/photo/<?php if (!empty($_smarty_tpl->tpl_vars['don']->value['photo'])) {
echo $_smarty_tpl->tpl_vars['don']->value['photo'];
} else { ?>no-banner.jpg<?php }?>" /></td>
