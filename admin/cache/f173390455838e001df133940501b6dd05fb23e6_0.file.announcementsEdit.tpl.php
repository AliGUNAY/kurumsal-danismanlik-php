<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-12 15:30:02
  from "/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/announcementsEdit.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_5784e2ca68d716_66515196',
  'file_dependency' => 
  array (
    'f173390455838e001df133940501b6dd05fb23e6' => 
    array (
      0 => '/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/announcementsEdit.tpl',
      1 => 1468326601,
      2 => 'file',
    ),
  ),
...
function content_5784e2ca68d716_66515196 ($_smarty_tpl) {
...
?>
		...
		<header>
			<div class="row">		
				<div class="col-sm-12">
					<h4 class="pull-left"><i class="fa fa-pencil antagon-color-main"></i> Etkinlik Ayarları</h4>
		...
		<div id="content">
			<div class="row">
				<form class="verikaydet" action="index.php?page=page/announcements/update" method="post" enctype="multipart/form-data">
					...
					<section id="headings" class="menu-anchor">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Etkinlik Ayarları</h3>
							</div>
								...
								<div class="page-header">
									<div class="form-horizontal">
										...
										<div class="form-group">
											<label for="title" class="col-sm-2 control-label">Etkinlik Başlık</label>
											<div class="col-sm-10">
