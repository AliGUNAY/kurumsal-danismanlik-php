<?php
/* Smarty version 3.1.30-dev/18, created on 2016-06-21 11:52:37
  from "/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/corporate.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_57690055696304_76040824',
  'file_dependency' => 
  array (
    'bd29f5c63673a2da3429316d554f610df3a9613a' => 
    array (
      0 => '/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/corporate.tpl',
      1 => 1466499154,
      2 => 'file',
    ),
  ),
...
function content_57690055696304_76040824 ($_smarty_tpl) {
...
>
		...
		<div id="content">
			<div class="row">
				<form class="verikaydet" action="index.php?page=page/corporate" method="post" enctype="multipart/form-data">
...
">
				...
				<div class="col-sm-6">
					<section id="headings" class="menu-anchor">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">Tasarım Ayarları</h3>
							</div>
							<div class="panel-body">
								<div class="page-header">
									<div class="form-horizontal">
										<div class="form-group">
											<div class="col-sm-10">
												<div class="custom-checkbox">
													<label>
														<input name="news" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['modules']->value[1]['status'] == 1) {?> checked <?php }?>>
														<span> Haberler Gözüksünmü?</span>
													</label>
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-10">
												<div class="custom-checkbox">
													<label>
														<input name="sliders" type="checkbox" <?php if ($_smarty_tpl->tpl_vars['modules']->value[0]['status'] == 1) {?> checked <?php }?>>
														<span> Slideshow Gözüksünmü?</span>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-12">
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-new thumbnail" style="">
													<img src="../upload/photo/<?php echo $_smarty_tpl->tpl_vars['homepage']->value['photo'];?>
">
												</div>
				...
				<?php if ($_smarty_tpl->tpl_vars['categorys']->value['status'] == 1) {?>			
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a data-toggle="modal" href="#long" class="btn btn-cyanide"><i class="fa fa-tags"></i> Alt Kategori Ekle</a>
									</div>
							...
							<div class="panel-body">
								<div class="panel panel-default">
										...
										<table class="table table-striped">
											...
											<tbody>
											<?php if ($_smarty_tpl->tpl_vars['lower']->value == TRUE) {?>
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['lower']->value, 'lowerDon');
foreach ($_from as $_smarty_tpl->tpl_vars['lowerDon']->value) {
$_smarty_tpl->tpl_vars['lowerDon']->_loop = true;
$__foreach_lowerDon_0_saved = $_smarty_tpl->tpl_vars['lowerDon'];
?>
												<tr>
													<td><?php echo $_smarty_tpl->tpl_vars['lowerDon']->value['id'];?>
</td>
													<td><?php echo $_smarty_tpl->tpl_vars['lowerDon']->value['seo_title'];?>
</td>
													<td>
														<a href="index.php?page=page/corporate/edit&id=<?php echo $_smarty_tpl->tpl_vars['lowerDon']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a class="divtikla" href="index.php?page=page/corporate/delete&id=<?php echo $_smarty_tpl->tpl_vars['lowerDon']->value['id'];?>
"><span class="label label-danger"><i class="fa fa-times" aria-hidden="true"></i> Sil</span></a>
													</td>
												</tr>
											<?php
$_smarty_tpl->tpl_vars['lowerDon'] = $__foreach_lowerDon_0_saved;
}
...
?>
		...
		<?php if ($_smarty_tpl->tpl_vars['categorys']->value['status'] == 1) {?>	
			<div id="long" class="modal fade" tabindex="-1" data-replace="true" data-width="760" style="display: none;">
				<form class="popupkaydet" action="index.php?page=page/corporate/add" method="post" enctype="multipart/form-data">
				<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['tokenID']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" />
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">Yeni Bir Alt Kategori Ekleme</h4>
				</div>
				<div class="modal-body">
					<div class="col-sm-7 col-md-7">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group" style="margin-bottom: 3px;">
									<input type="text" name="seo_keyword" class="form-control" id="title" placeholder="Google arama sıralamasında gozuken başlık">
									<span class="input-group-btn">
										  <a class="btn btn-midnight" data-container="body" data-toggle="popover" data-placement="top" data-content="Google Arama sayfalarında kelime arandıkdan sonra listelenen sitelerde başlık altındakı siyah renkde olan kısa açıklamaları bu bölümden ayarlayabilirsiniz" data-original-title="" title="" aria-describedby="popover464119"><i class="fa fa-question"></i></a>
									</span>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="input-group" style="margin-bottom: 3px;">
									<input type="text" name="seo_description" class="form-control" id="title" placeholder="Google arama sıralamasında gozuken başlık">
									<span class="input-group-btn">
										  <a class="btn btn-midnight" data-container="body" data-toggle="popover" data-placement="top" data-content="Google Arama sayfalarında kelime arandıkdan sonra listelenen sitelerde başlık altındakı siyah renkde olan kısa açıklamaları bu bölümden ayarlayabilirsiniz" data-original-title="" title="" aria-describedby="popover464119"><i class="fa fa-question"></i></a>
									</span>
								</div>
					...
					<div class="col-sm-5 col-md-5 kolon">
						
						<div class="row">
								<div id="1" class="col-cus-2 active col-lg-5 kutusec">Sadece Yazı Sayfası</div>
								<div id="2" class="col-two col-lg-5 kutusec">Görsel+Yazı Sayfası</div>
								<div id="3" class="col-cus-1 col-lg-5 kutusec">Görsel Galeri</div>
						</div>
					</div>
