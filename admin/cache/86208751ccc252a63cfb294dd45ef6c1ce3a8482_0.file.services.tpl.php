<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-13 16:05:03
  from "/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/services.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_57863c7fe9f5e9_97107241',
  'file_dependency' => 
  array (
    '86208751ccc252a63cfb294dd45ef6c1ce3a8482' => 
    array (
      0 => '/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/services.tpl',
      1 => 1468415102,
      2 => 'file',
    ),
  ),
...
function content_57863c7fe9f5e9_97107241 ($_smarty_tpl) {
					...
					<section id="headings" class="menu-anchor">
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<div class="pull-right">
									<a data-toggle="modal" href="#long" class="btn btn-cyanide"><i class="fa fa-tags"></i> Hizmet Ekle</a>
									</div>
									<div class="clearfix"></div>
							</div>
							<div class="panel-body">
...
?>
		...
		<?php if ($_smarty_tpl->tpl_vars['categorys']->value == 1) {?>	
			<div id="long" class="modal fade" tabindex="-1" data-replace="true" data-width="760" style="display: none;">
				<form class="popupkaydet" action="index.php?page=page/services/add" method="post" enctype="multipart/form-data">
				<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['tokenID']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" />
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title">Yeni Bir Hizmet Ekleme</h4>
				</div>
