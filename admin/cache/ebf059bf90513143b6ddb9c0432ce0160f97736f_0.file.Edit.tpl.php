<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-14 16:15:16
  from "/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/scope/Edit.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_578790646ce158_53331734',
  'file_dependency' => 
  array (
    'ebf059bf90513143b6ddb9c0432ce0160f97736f' => 
    array (
      0 => '/home/istwt/domains/istanbulwebtasarim.com/public_html/demo/yenipanel/theme/admin/pages/scope/Edit.tpl',
      1 => 1468493997,
      2 => 'file',
    ),
  ),
...
function content_578790646ce158_53331734 ($_smarty_tpl) {
...
?>
		...
		<header>
			<div class="row">		
				<div class="col-sm-12">
					<h4 class="pull-left"><i class="fa fa-pencil antagon-color-main"></i> Sosyal Proje Ayarları</h4>
		...
		<div id="content">
			<div class="row">
				<form class="verikaydet" action="index.php?page=page/scope/update" method="post" enctype="multipart/form-data">
								...
								<div class="page-header">
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<div class="input-group" style="margin-bottom: 3px;">
													<textarea name="content" id="ckeditor" id="ckeditor" class="ckeditor"><?php echo $_smarty_tpl->tpl_vars['lower']->value['content'];?>
</textarea>
												</div>
											</div>
										</div>
