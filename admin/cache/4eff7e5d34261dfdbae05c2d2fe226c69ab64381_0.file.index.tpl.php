<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-20 10:15:40
  from "/home/goxskons/public_html/theme/admin/pages/announcements/index.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_578f251c4489e8_10201713',
  'file_dependency' => 
  array (
    '4eff7e5d34261dfdbae05c2d2fe226c69ab64381' => 
    array (
      0 => '/home/goxskons/public_html/theme/admin/pages/announcements/index.tpl',
      1 => 1468998934,
      2 => 'file',
    ),
  ),
...
function content_578f251c4489e8_10201713 ($_smarty_tpl) {
...
>
		...
		<div id="content">
			<div class="row">
				<form class="verikaydet" action="index.php?page=page/announcements" method="post" enctype="multipart/form-data">
							...
							<div class="panel-body">
								<div class="panel panel-default">
										...
										<table class="table table-striped table-hover table-bordered">
											...
											<tbody id="sortable" data-page="page/announcements/sort">
...
" data-database="page/announcements/status" data-id="<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['don']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td>
														<a href="index.php?page=page/announcements/edit&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a class="divtikla" href="index.php?page=page/announcements/delete&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
...
?>
		...
		<?php if ($_smarty_tpl->tpl_vars['categorys']->value == 1) {?>	
			<div id="long" class="modal fade" tabindex="-1" data-replace="true" data-width="760" style="display: none;">
				<form class="popupkaydet" action="index.php?page=page/announcements/add" method="post" enctype="multipart/form-data">
				<input type="hidden" name="<?php echo $_smarty_tpl->tpl_vars['tokenID']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['token']->value;?>
" />
