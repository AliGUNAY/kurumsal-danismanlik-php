<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-19 16:13:11
  from "/home/goxskons/public_html/theme/admin/pages/press/index.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_578e2767ee5f34_55976830',
  'file_dependency' => 
  array (
    '1fa14a4fefcdff550fc09380525a6d7ffbad5518' => 
    array (
      0 => '/home/goxskons/public_html/theme/admin/pages/press/index.tpl',
      1 => 1468933990,
      2 => 'file',
    ),
  ),
...
function content_578e2767ee5f34_55976830 ($_smarty_tpl) {
...
?>
												<?php if ($_smarty_tpl->tpl_vars['categorydon']->value['ustkategori'] == 0) {?>
...
" data-database="page/press/category/status" data-id="<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['categorydon']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td>
														<a href="index.php?page=page/press/category/edit&id=<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a style="display:none" class="divtikla" href="index.php?page=page/press/category/delete&id=<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
							...
							<div class="panel-body">
								<div class="panel panel-default">
										<table class="table table-striped">
											...
											<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['products']->value, 'don', false, 'k');
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['don']->value) {
...
" data-database="page/press/status" data-id="<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['don']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td>
														<a href="index.php?page=page/press/edit&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a class="divtikla" href="index.php?page=page/press/delete&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
"><span class="label label-danger"><i class="fa fa-times" aria-hidden="true"></i> Sil</span></a>
													</td>
												</tr>
											<?php
