<?php
/* Smarty version 3.1.30-dev/18, created on 2016-07-19 16:10:56
  from "/home/goxskons/public_html/theme/admin/pages/services/index.tpl" */

if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.30-dev/18',
  'unifunc' => 'content_578e26e016c987_49481214',
  'file_dependency' => 
  array (
    'f51a5cc523fbe171c7d2124ac3245f2a06c52452' => 
    array (
      0 => '/home/goxskons/public_html/theme/admin/pages/services/index.tpl',
      1 => 1468933852,
      2 => 'file',
    ),
  ),
...
function content_578e26e016c987_49481214 ($_smarty_tpl) {
...
" data-database="page/services/category/status" data-id="<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['categorydon']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td>
														<a href="index.php?page=page/services/category/edit&id=<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a class="divtikla" href="index.php?page=page/services/category/delete&id=<?php echo $_smarty_tpl->tpl_vars['categorydon']->value['id'];?>
...
" data-database="page/services/status" data-id="<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
...
" class="btn <?php if ($_smarty_tpl->tpl_vars['don']->value['status'] == 0) {?>btn-primary<?php } else { ?>btn-danger<?php }?> btn-xs status"><i class="fa fa-star" aria-hidden="true"></i></button></td>
													...
													<td>
														<a href="index.php?page=page/services/edit&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
"><span class="label label-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Düzenle</span></a>
														<a class="divtikla" href="index.php?page=page/services/delete&id=<?php echo $_smarty_tpl->tpl_vars['don']->value['id'];?>
"><span class="label label-danger"><i class="fa fa-times" aria-hidden="true"></i> Sil</span></a>
													</td>
												</tr>
											<?php
