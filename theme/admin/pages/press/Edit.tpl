	...
	<aside>
		...
		<div id="content">
			<div class="row">
				...
				<div class="col-sm-6">
					<section id="headings" class="menu-anchor">
						<div class="panel panel-default" id="resimgaleri" style="{if $lower.tip eq 2}display:none{/if}">
							<div class="panel-heading">
						...
						<div class="panel panel-default" id="videogaleri" style="{if $lower.tip eq 1}display:none{/if}">
							<div class="panel-heading">
							...
							<div class="panel-body">
								<div class="page-header">
									<div class="form-horizontal">
										...
										{foreach from=$videogallery item=videogalleryDon}
											<div class="col-md-4 pic" data-image="{$videogalleryDon.url}" style="margin-bottom:10px">
												<div class="thumbnail-hover thumbnail-fade">
													<img style="width: 100%; height: 200px; object-fit: cover;" src="http://i1.ytimg.com/vi/{$videogalleryDon.url}/sddefault.jpg" class="img-responsive img-thumbnail">
													<div class="pic-caption rotate-in pic-icon">
														<span class="btn btn-success btn-lg resimsil" data-image="{$videogalleryDon.url}"><i class="fa fa-trash"></i></span>
													</div>
												</div>
											</div>
										{/foreach}
										...
										<textarea id="jsons" name="videogallery" style="display:none">{$lower.videogallery}</textarea>
										<br />
										<div class="clearfix"></div>
										<div id="progress" class="progress progress-striped">
											<div class="progress-bar progress-bar-cello"></div>
